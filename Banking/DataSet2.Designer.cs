...
namespace Banking {
    ...
    public partial class DataSet2 : global::System.Data.DataSet {
        ...
        public partial class ProfileDataTable : global::System.Data.TypedTableBase<ProfileRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProfileRow AddProfileRow(string Name, long AccountNo, string Detail, System.DateTime Date, string Status, decimal Balance, decimal Amount, string IFSCCode) {
...
namespace Banking.DataSet2TableAdapters {
    ...
    public partial class ProfileTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Profile] WHERE (([Name] = @Original_Name) AND ([AccountNo] = @Original_AccountNo) AND ([Detail] = @Original_Detail) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ([Status] = @Original_Status) AND ([Balance] = @Original_Balance) AND ([Amount] = @Original_Amount) AND ([IFSCCode] = @Original_IFSCCode) AND ([ProfileID] = @Original_ProfileID))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Profile] SET [Name] = @Name, [AccountNo] = @AccountNo, [Detail] = @Detail, [Date] = @Date, [Status] = @Status, [Balance] = @Balance, [Amount] = @Amount, [IFSCCode] = @IFSCCode WHERE (([Name] = @Original_Name) AND ([AccountNo] = @Original_AccountNo) AND ([Detail] = @Original_Detail) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)) AND ([Status] = @Original_Status) AND ([Balance] = @Original_Balance) AND ([Amount] = @Original_Amount) AND ([IFSCCode] = @Original_IFSCCode) AND ([ProfileID] = @Original_ProfileID));
SELECT Name, AccountNo, Detail, Date, Status, Balance, Amount, IFSCCode, ProfileID FROM Profile WHERE (ProfileID = @ProfileID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Name, AccountNo, Detail, Date, Status, Balance, Amount, IFSCCode, ProfileI" +
                "D FROM Profile";
